...
It does **NOT** write: the per-subject deep-design (Step 4), the story/economy spine (Step 2), the feedback
review (Step 5), or any TOML / ledger structure / green build (Step 6).
