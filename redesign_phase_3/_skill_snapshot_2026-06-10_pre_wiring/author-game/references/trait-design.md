...
- This is independent of `scope_mode`: even a FULL game keeps most NPCs light (RTS is full and still
  reserves the rich model for 3). Gold-plating every NPC is the failure — it dilutes the core and
  triples the authoring. (`rts-design-philosophy.md` P5.)
