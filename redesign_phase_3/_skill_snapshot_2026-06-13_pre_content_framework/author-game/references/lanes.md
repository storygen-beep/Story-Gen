...
- **A solo host can fire a PLAYER-LEWD event, not only an NPC walk-in** (`references/step-5-roster.md`).
  ...
  **player/world lewd track** — solo self-acts, location flashing/exhibitionism, public dares, job-lewd
  ...
  NPC-centric and omits this whole category — invent it in the content roster, not at the canvas. A
  game with rich NPC arcs but no feeder catalog starves its player odometer (the Last Call finding).
