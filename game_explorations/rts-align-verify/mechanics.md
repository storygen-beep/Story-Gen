# rts-align-verify — Mechanical Patterns
...
## Scenes catalogued
- Distinct passage names visited: 2 (the "Unique states seen" count in report.md includes variable-permutations of the same passage).
