# Pathfinder dryrun — zaras-school-life

Trials: 3  |  Seed: 1  |  Median step latency: 0ms

## Summary

| Metric | Value |
|---|---|
| clean_completion_rate (of measurable) | 0.0% |
| clean_completion_rate (of total) | 0.0% |
| divergence_rate | 0.0% |
| click_failed_rate | 0.0% |
| plan_failed_rate | 100.0% |
