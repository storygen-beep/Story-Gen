...
Generated: 2026-04-16T19:00:29.989Z
Source URL: https://mopoga.com/zaras-school-life

## Session Summary

- Sessions run: 1
- Total wall-clock: 36m 12s
- Total clicks: 80
- Total choices explored: 80
- Unique states seen: 94
...
|---|---|---|---|---|
| `jessica.reputation` | number | 98..102 | 3 | high |
| `janet.willpower` | number | -2..0 | 1 | high |

### npc_stat (6)

| name | type | range / samples | mutations | confidence |
|---|---|---|---|---|
| `PlayerCorruption` | number | 0..25 | 4 | high |
| `dad.corruption` | number | 0..0 | 0 | high |
| `bro.corruption` | number | 0..0 | 0 | high |
| `mom.corruption` | number | 0..0 | 0 | high |
| `dick.corruption` | number | 20..20 | 0 | high |
| `dick.lust` | number | 20..20 | 0 | high |

### time (2)

| name | type | range / samples | mutations | confidence |
|---|---|---|---|---|
| `hour` | number | 8..21 | 25 | high |
| `day` | number | 1..6 | 2 | high |
...
| `PlayerOneQuestDone` | boolean | false | 0 | high |
...
| `PlayerShower` | boolean | false | 0 | high |
| `PlayerGymAttire` | boolean | true | 0 | high |
| `PlayerGymAdv` | boolean | false | 0 | high |
| `PlayerSwimWear` | boolean | false | 0 | high |
| `PlayerSchoolUniSlutty` | boolean | false, true | 1 | high |
| `PlayerSluttyClothes` | boolean | false | 0 | high |
| `PlayerCam` | boolean | false | 0 | high |
| `PlayerTab` | boolean | false | 0 | high |
| `PlayerPhone` | boolean | false | 0 | high |
| `PlayerDildo` | boolean | false | 0 | high |
...
| `dailyHangBro` | boolean | false | 0 | high |
...
| `detentionFlag` | boolean | false, true | 5 | high |
...
| `PlayerMoney` | number | 0..300 | 2 | low |
| `PlayerEnergy` | number | 0..105 | 27 | low |
| `PlayerMaxEnergy` | number | 100..105 | 3 | low |
| `PlayerSchoolRep` | number | 0..30 | 8 | low |
| `PlayerFitness` | number | 0..5 | 3 | low |
| `PlayerActiveQuest` | number | 0..0 | 0 | low |
| `PlayerArt` | number | 0..4 | 3 | low |
| `PlayerSci` | number | 0..4 | 3 | low |
| `PlayerComp` | number | 0..4 | 3 | low |
| `playerActiveQuests` | number | 0..2 | 3 | low |
...
| `bro.dailyVisits` | number | 0..0 | 0 | low |
| `bro.rejectDay` | number | 0..0 | 0 | low |
| … | … | … | … | and 61 more |
...
| name | type | range / samples | mutations | confidence |
|---|---|---|---|---|
| `PlayerClothes` | string | `Casual`, `SchoolUni`, `SluttyUni` | 5 | low |
| `drugStatusAlt` | string | `F` | 0 | low |
| `dayOfWeek` | string | `Monday`, `Thursday` | 1 | low |
...
| `return` | string | `Welcome Page`, `dream1`, `School` | 64 | low |
| `timeOfDay` | string | `Day`, `Night` | 2 | low |
| `currentSchoolClass` | string | `Art`, ``, `Science` | 17 | low |
| `classActivity` | string | ``, `Studying` | 16 | low |
| `currentPassage` | string | `Classes` | 0 | low |
| `counter` | string | `1ms` | 0 | low |
...
- **relationship** (7): `dick.relationship`, `ben.relationship`, `jason.relationship`, `daniel.relationship`, `lisa.relationship`, `jessica.relationship`, …
...
- **corruption** (4): `dad.corruption`, `bro.corruption`, `mom.corruption`, `dick.corruption`
...
|---|---|---|---|---|---|---|
| 1 | 2026-04-16T18:24:17.884Z | 36m 12s | 80 | 80 | 94 | no |
