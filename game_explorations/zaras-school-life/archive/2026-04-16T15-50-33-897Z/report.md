...
Generated: 2026-04-16T15:49:36.622Z
Source URL: https://mopoga.com/zaras-school-life

## Session Summary

- Sessions run: 1
- Total wall-clock: 9m 22s
- Total clicks: 40
- Total choices explored: 40
- Unique states seen: 39
...
| name | type | range / samples | mutations | confidence |
|---|---|---|---|---|
| `PlayerCorruption` | number | 0..1 | 3 | high |
...
| name | type | range / samples | mutations | confidence |
|---|---|---|---|---|
| `hour` | number | 8..14 | 6 | high |
| `day` | number | 1..2 | 3 | high |
...
| `CDstart` | boolean | false, true | 2 | high |
| `CDstop` | boolean | false, true | 2 | high |
...
| `PlayerEnergy` | number | 35..100 | 5 | low |
| `PlayerMaxEnergy` | number | 100..101 | 1 | low |
| `PlayerSchoolRep` | number | 0..1 | 1 | low |
| `PlayerFitness` | number | 0..1 | 1 | low |
| `PlayerActiveQuest` | number | 0..0 | 0 | low |
| `PlayerArt` | number | 0..1 | 1 | low |
| `PlayerSci` | number | 0..0 | 0 | low |
| `PlayerComp` | number | 0..1 | 1 | low |
...
| name | type | range / samples | mutations | confidence |
|---|---|---|---|---|
| `PlayerClothes` | string | `Casual`, `SchoolUni` | 1 | low |
| `drugStatusAlt` | string | `F` | 0 | low |
| `dayOfWeek` | string | `Monday`, `Tuesday` | 3 | low |
...
| `return` | string | `Welcome Page`, `dream1`, `wakeup_dream` | 28 | low |
| `timeOfDay` | string | `Day` | 0 | low |
| `currentSchoolClass` | string | `Art`, ``, `Science` | 7 | low |
| `classActivity` | string | ``, `Studying`, `Studying Hard` | 10 | low |
...
|---|---|---|---|---|---|---|
| 1 | 2026-04-16T15:40:14.901Z | 9m 22s | 40 | 40 | 39 | no |
