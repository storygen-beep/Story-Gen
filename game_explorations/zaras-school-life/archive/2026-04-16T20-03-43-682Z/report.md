...
Generated: 2026-04-16T19:57:11.563Z
Source URL: https://mopoga.com/zaras-school-life

## Session Summary

- Sessions run: 1
- Total wall-clock: 28s
- Total clicks: 3
...
|---|---|---|---|---|---|---|
| 1 | 2026-04-16T19:56:43.404Z | 28s | 3 | 3 | 4 | no |

## Graph coverage (observed vs. static)

- Static-graph edges (passages reachable from each other according to source): **2416**
- Observed edges during play: **3** (4 of them line up with static edges, 1 are observed-only — self-loops or expanded replace blocks).
