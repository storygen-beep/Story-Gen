...
`advanceTime(minutes)` (`v2.py:5569`) adds minutes to `time_state` and rolls the day when the hours
...
(`v2.py:13819`, `config.get('default_time_progression', 3)`; the exception fallback at `:13388`
