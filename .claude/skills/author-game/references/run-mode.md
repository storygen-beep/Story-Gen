...
| 4 — NPC arcs | **ONE NPC at a time** | **A** per *core* NPC; **B** for peripherals |
| 5 — roster | the scene list | **B** (surface the list; **A** only on a real fork) |
...
4** (one NPC at a time — the heart). **Step 4 + Step 6 are where one-shot is actually banned.**
