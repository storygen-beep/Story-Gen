...
> **Antigravity / CDP Environments:**
> Connect Playwright or Chrome DevTools MCP directly to the open Chrome/Canary instance running on port 9222:
> `const browser = await chromium.connectOverCDP('http://localhost:9222')`
> This drives the user's active browser session directly with zero CAPTCHA or SafeSearch restrictions.
